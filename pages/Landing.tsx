...
import { ChefHat, CheckCircle2, TrendingUp, AlertTriangle, ArrowRight, Star, LayoutDashboard } from 'lucide-react';
      ...
      <header className="fixed w-full bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            {user ? (
              <Link to="/dashboard" className="bg-orange-600 text-white px-5 py-2 rounded-full font-bold hover:bg-orange-700 transition shadow-lg flex items-center gap-2">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to={user ? "/dashboard" : "/auth"} className="bg-orange-600 text-white text-lg px-8 py-4 rounded-full font-bold hover:bg-orange-700 transition shadow-xl flex items-center justify-center gap-2">
              {user ? "Acessar Meu Painel" : "Começar Grátis Agora"} <ArrowRight />
            </Link>
            {!user && (
